...
async function testCall() {
  try {
    result = await web3.eth.personal.sign('Welcome to goosepunks gaming! This is your 1st Step to the metaverse. Sign This GP Token To Get Started', user.get('ethAddress'));
  } catch (error) {
